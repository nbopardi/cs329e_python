...
class Game():
    ...
    def play(self):
        ...
        for x in output:
            ...
            endGame = Button(win,text="End Game",command=lambda:[win.destroy(),main()])
            endGame.grid(row=1)
...
def main():
    ...
    Poker = Button(root, text="Click here to play Poker", command= lambda: [root.destroy(),playerList.clear(),Game()])
    Poker.pack()
